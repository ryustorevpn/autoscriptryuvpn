...
wget -O /etc/nginx/nginx.conf "https://autosscript.site/aio/nginx.conf"
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://autosscript.site/aio/newudpgw"
