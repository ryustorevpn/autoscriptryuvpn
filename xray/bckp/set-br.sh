...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/apih46/mini/main/bckp/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/apih46/mini/main/bckp/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/apih46/mini/main/bckp/logcleaner.sh" && chmod +x /usr/bin/cleaner
