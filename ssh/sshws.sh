...
wget -q -O /usr/bin/proxy3.js "https://autosscript.site/aio/ssh/proxy3.js"
...
wget -q -O /usr/bin/ssh-wsenabler "https://autosscript.site/aio/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler
