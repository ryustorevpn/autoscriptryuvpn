...
wget -q -O /usr/bin/proxy3.js "https://github.com/ryustorevpn/autoscriptryuvpn/main/ssh/proxy3.js"
...
wget -q -O /usr/bin/ssh-wsenabler "https://github.com/ryustorevpn/autoscriptryuvpn/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler
